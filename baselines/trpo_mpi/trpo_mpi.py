...
def learn(*,
    ...
    **network_kwargs        keyword arguments to the policy / network builder. See baselines.common/policies.py/build_policy and arguments to a particular type of network
    ...
    policy = build_policy(env, network, value_network=None, **network_kwargs)
    ...
    while True:
        ...
        esttime = time.strftime("%H:%M:%S", time.gmtime((time.time() - tstart)/timesteps_so_far*(total_timesteps-timesteps_so_far)))
